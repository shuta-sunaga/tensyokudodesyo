...
(function (global) {
    ...
    const BUCKETS = [
        { id: 'sales',         name: '営業職',                                 short: '営業',               re: /営業/ },
        { id: 'it',            name: 'ITエンジニア',                           short: 'IT',                 re: /IT|ＩＴ|システム|Web|ＷＥＢ|ソフト|プログラ|インフラ|ネットワーク|ゲーム/ },
        { id: 'service',       name: '販売・サービス職',                       short: '販売・サービス',     re: /販売|サービス|飲食|フード|外食|小売|店舗|接客|レジャー|美容|ブライダル|ホテル|清掃|アミューズメント|流通|ヘルスケア/ },
        { id: 'skilled',       name: '技能工・設備・配送・農林水産',           short: '技能工・運輸',       re: /技能工|運輸|交通|物流|配送|倉庫|ドライバー|運転|施設|警備|整備/ },
        { id: 'manufacturing', name: '製造・生産・品質管理',                   short: '製造・生産',         re: /製造|生産|品質|技能|モノづくり|ものづくり|溶接|組立|期間工|SCM|購買/ },
        { id: 'construction',  name: '技術職（建築・土木・プラント・設備）',   short: '建築・土木・設備',   re: /建築|建設|土木|プラント|不動産|施工|工場/ },
        { id: 'chem',          name: '技術職（医薬・化学・素材・食品）',       short: '化学・素材・食品',   re: /医薬|化学|素材|食品|香料|飼料|化粧品|トイレタリー|バイオ/ },
        { id: 'tech',          name: '技術職（電気・電子・機械・半導体）',     short: '電気・機械の技術職', re: /機械|電気|電子|半導体|メーカー|技術職|技術系|エンジニア|制御|機構|設計|研究|開発/ },
        { id: 'medical',       name: '医療・福祉・介護',                       short: '医療・福祉',         re: /医療|福祉|介護|保育|看護|メディカル|薬剤/ },
        { id: 'office',        name: '事務・管理部門職',                       short: '事務・管理',         re: /事務|管理部門|コーポレート|経営|企画|マーケ|人事|総務|経理|受付|秘書|翻訳|管理職|管理・|管理$|アシスタント/ },
        { id: 'specialist',    name: '専門職・その他',                         short: '専門職・その他',     re: /専門職|コンサル|士業|教育|教員|通訳|公務員|クリエイ|デザイナー|ディレクター|カスタマー|コールセンター|サポート|人材|金融|農林水産/ },
    ];
    const OTHER = { id: 'other', name: 'その他', short: 'その他' };
    // 旧 ID（URL の ?cat=）との互換
